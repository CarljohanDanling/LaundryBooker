namespace LaundryBooker.DataLayer.Database.DatabaseContext
{
    ...
    public class LaundryContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookingSession>().HasData(
                new BookingSession()
                {
                    Id = Guid.Parse("23e00cbf-7a2e-43ee-8a7a-6b21eb4513d4"),
                    StartTime = new DateTimeOffset(2020, 07, 5, 14, 00, 00, new TimeSpan(2, 0, 0)),
                    EndTime = new DateTimeOffset(2020, 07, 5, 21, 00, 00, new TimeSpan(2, 0, 0)),
                    TenantId = 2,
                    LaundryRoomId = 23,
                    SessionStatus = BookingSessionStatus.Scheduled
                });
